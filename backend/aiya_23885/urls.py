...
admin.site.site_header = "Aiya"
admin.site.site_title = "Aiya Admin Portal"
admin.site.index_title = "Aiya Admin"

# swagger
api_info = openapi.Info(
    title="Aiya API",
    default_version="v1",
    description="API documentation for Aiya App",
)
